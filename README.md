...
2.  **Configure Connection String:**
    * Open the configuration file (usually `appsettings.json` ) located in the **startup project's root**.
...
1.  After the tables are created, execute any necessary stored procedures or seed data.
2.  Navigate to the project's scripts folder: `PatientTestManager.Domain/Scripts`.
